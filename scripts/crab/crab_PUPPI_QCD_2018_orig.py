...
inputDatasets = ['/QCD_Pt-15to7000_TuneCP5_Flat_13TeV_pythia8/RunIIAutumn18MiniAOD-FlatPU0to70RAW_102X_upgrade2018_realistic_v15_ext2-v1/MINIAODSIM']
...
config = config()
config.General.workArea = 'crab_PUPPI_QCD_2018_ultimatev13'
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/PUPPIStudies/QCD_2018_ultimatev13/' % (getUsernameFromSiteDB())
