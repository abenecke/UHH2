...
inputDatasets = ['/WprimeToWhToWhadhbb_narrow_M-2000_13TeV-madgraph/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM']
...
config = config()
config.General.workArea = 'crab_VH_WPrime'
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/VH_Wprime' % (getUsernameFromSiteDB())
