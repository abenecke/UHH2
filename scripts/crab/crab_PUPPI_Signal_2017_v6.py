...
config = config()
config.General.workArea = 'crab_PUPPI_Signal_2017_v6'
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/PUPPIStudies/Signal_2017_v6/' % (getUsernameFromSiteDB())
