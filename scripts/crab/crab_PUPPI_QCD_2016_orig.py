...
config = config()
config.General.workArea = 'crab_PUPPI_QCD_2016_orig_const'
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/PUPPIStudies/QCD_2016_orig_const/' % (getUsernameFromSiteDB())
