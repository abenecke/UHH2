...
config = config()
config.General.workArea = 'crab_PUPPI_Signal_2017_v8'
config.General.transferOutputs = True
config.General.transferLogs = True
        
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = os.path.join(os.environ['CMSSW_BASE'], 'src/UHH2/core/python/ntuplewriter_mc_2017v2_PUPPI_v8.py')
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/PUPPIStudies/Signal_2017_v8/' % (getUsernameFromSiteDB())
