...
inputDatasets = ['/TprimeBToTH_M-*_RH_TuneCUETP8M1_13TeV-madgraph-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM']
...
config = config()
config.General.workArea = 'crab_SingleVLQ'
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/SingleVLQ_2016v2/' % (getUsernameFromSiteDB())
