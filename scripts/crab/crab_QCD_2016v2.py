...
#inputDatasets = ['/ZprimeToZhToZhadhbb_narrow_M-2000_13TeV-madgraph/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM']
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/VH_QCD' % (getUsernameFromSiteDB())
