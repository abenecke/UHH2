...
config = config()
config.General.workArea = 'crab_PUPPI_QCD_2017_ultimatev13'
...
try:
    config.Data.outLFNDirBase = '/store/user/%s/RunII_102X_v1/PUPPIStudies/QCD_2017_ultimatev13/' % (getUsernameFromSiteDB())
