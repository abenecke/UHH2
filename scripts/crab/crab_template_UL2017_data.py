...
config = config()
config.General.workArea = 'crab_PUPPI_2017UL_data_jme_18_001_tune'
...
year = result.group()
config.Data.outLFNDirBase = '/store/user/abenecke/RunII_102X_v1/PUPPIStudies/Data_2017UL_jme_18_001/' 
